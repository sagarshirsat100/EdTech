...
const Navbar = () => {
  ...
  return (
    <div className={`flex items-genter justify-between px-4 sm:px-10 md:px-14 1g:px-36 border-b border-gray-500 py-4 ${isCourseListPage ? 'bg-white' : 'bg-cyan-100/70'}`}>
