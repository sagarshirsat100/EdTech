...
const CoursesDetails = () => {
  ...
  return courseData ? (<>
    <div className="flex md:flow-root flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:placeholder-teal-300 pt-20 text-left">
      ...
      <div className="max-w-xl z-10 text-gray-500">
        ...
        <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
          ...
          <div className='flex'>
            {[...Array(5)].map((_, i) => (<img key={i} src={(i < Math.floor(calculateRating(courseData)) ? assets.star : assets.star_blank)} alt='' className="" />
            ))}
          </div>
        ...
        <p>Course by <span className="text-blue-600 underline">Sagar</span></p>
          ...
          <div className="pt-5">
            {courseData.courseContent.map((chapter, index) => (
              <div key={index} className="border border-gray-300 bg-white mb-2 rounded">
                ...
                <p className="text-sm md:text-default px-4 pb-2">
      ...
      <div className="max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
        ...
        <div className="pt-5">
          <div className="flex items-center gap-2">
            ...
            <p className="text-red-500"><span className="font-medium">5 days left</span> left at this price</p>
          </div>
          ...
          <div className="flex items-center texsmq md:text-default gap-4 pt-2 md:pt-4 text-gray-500">
            ...
            </div><div className="h-4 w-px bg-red-500/40"></div>
            <div className="flex items-center gap-1">
